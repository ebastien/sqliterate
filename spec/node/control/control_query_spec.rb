...
describe "tables access control" do
  def parse(q)
    Sqliterate::QueryParser.new.parse q
  end
  ...
  it "parses select with multiple joins" do
    ...
    expect(t.tables).to eq(["t1","t2","t3"])
  end
